...
class ExpenseReportController extends Controller
{
    public function index()
    {
        ...
        $groupedExpenses = $expenses->whereNotNull('expense_category_id')->orderBy('amount', 'asc')->get()->groupBy('expense_category_id');
        $groupedIncomes  = $incomes->whereNotNull('income_category_id')->orderBy('amount', 'asc')->get()->groupBy('income_category_id');
