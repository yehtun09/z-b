                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('onu_model_no') ? 'is-invalid' : '' }}"
                                type="text" name="onu_model_no" id="onu_model_no" value="{{ old('onu_model_no', '') }}"
                                required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('ont_serial_no') ? 'is-invalid' : '' }}"
                                type="text" name="ont_serial_no" id="ont_serial_no" value="{{ old('ont_serial_no', '') }}"
                                required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('onu') ? 'is-invalid' : '' }}"
                                type="text" name="onu" id="onu" value="{{ old('onu', '') }}"
                                required>
                            @if ($errors->has('onu'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('onu') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('drum_no') ? 'is-invalid' : '' }}"
                                type="number" name="drum_no" id="drum_no" value="{{ old('drum_no', '') }}"
                               required >
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('patch_cord') ? 'is-invalid' : '' }}"
                                type="text" name="patch_cord" id="patch_cord" value="{{ old('patch_cord', '') }}"
                                >
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('drop_sleeve') ? 'is-invalid' : '' }}"
                                type="text" name="drop_sleeve" id="drop_sleeve" value="{{ old('drop_sleeve', '') }}"
                                >
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('sleeve_holder') ? 'is-invalid' : '' }}"
                                type="text" name="sleeve_holder" id="sleeve_holder" value="{{ old('sleeve_holder', '') }}"
                                >
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('model_no') ? 'is-invalid' : '' }}" type="text"
                                name="model_no" id="model_no" value="{{ old('model_no', '') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="price" id="price" value="{{ old('price', '') }}" min="0" step="0.01"
                                required>
                            @if ($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="stock_qty" id="stock_qty" value="{{ old('stock_qty', '') }}" min="0" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="discount" id="discount" value="{{ old('discount', '') }}" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                name="length" id="length" value="{{ old('length', '0') }}" min="0">
