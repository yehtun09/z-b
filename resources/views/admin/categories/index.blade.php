...
@section('content')
    <div class="card">
        <div class="custom-header">
            {{ trans('cruds.category.title_singular') }} {{ trans('global.listings') }}
            @can('category_create')
                <div class="">
                    <a class="  btn btn-success" href="{{ route('admin.categories.create') }}">
                        {{ trans('global.add') }} {{ trans('cruds.category.title_singular') }}
                    </a>
                    <a href="{{ route('admin.categories.list.trash') }}" class="  btn btn-primary">Trash</a>
                </div>
            @endcan
        </div>
                                        ...
                                        @can('category_delete')
                                            <form id="orderDelete-{{ $category->id }}"
                                                ...
                                                <button
                                                    ...
                                                    class=" p-0 glow"
                                                    onclick="event.preventDefault(); document.getElementById('orderDelete-{{ $category->id }}').submit();">
