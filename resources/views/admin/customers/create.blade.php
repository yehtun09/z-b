        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.customers.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('ticket_no') ? 'is-invalid' : '' }}" type="text"
                                name="ticket_no" id="ticket_no" value="{{ old('ticket_no', '') }}">
                            ...
                            <select  class="form-control {{ $errors->has('service_type_id') ? 'is-invalid' : '' }}"
                                ...
                                @foreach ($service_types as $id => $entry)
                                    <option value="{{ $entry->id }}"
                                        {{ old('service_type_id') == $entry->id ? 'selected' : '' }}>
                                        {{ $entry->service_type }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select  class="form-control {{ $errors->has('service_plan_id') ? 'is-invalid' : '' }}"
                                ...
                                @foreach ($service_plans as $id => $entry)
                                    <option value="{{ $entry->id }}"
                                        {{ old('service_plan_id') == $entry->id ? 'selected' : '' }}>
                                        {{ $entry->service_plan }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('bandwidth') ? 'is-invalid' : '' }}"
                                type="text" name="bandwidth" id="bandwidth" value="{{ old('bandwidth', '') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('site_lat') ? 'is-invalid' : '' }}" type="text"
                                name="site_lat" id="site_lat" value="{{ old('site_lat', '') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('site_long') ? 'is-invalid' : '' }}"
                                type="text" name="site_long" id="site_long" value="{{ old('site_long', '') }}" required>
                    ...
                    {{-- End MultiRow of Site Lat & Site Long  --}}
                </div>

                <div class="form-group d-flex mt-2 ms-4 mb-2">
