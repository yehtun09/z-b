...
@section('content')
    ...
    <div class="card">
        <div class="custom-header">
            ...
            {{ trans('global.completed') }} {{ trans('global.services') }} {{ trans('global.listings') }}
            <div class="d-flex">
                <!-- Range Picker-->
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click', '#filter', function() {
            ...
            $.ajax({
                type: 'GET',
                url: '/admin/customer-assigns/action/completed',
                data: {
                    startDate: startDate,
                    endDate: endDate,
                },
        ...
        $(document).on('click', '#export', function() {
            ...
            var url = "{{ route('admin.export.completed') }}?" + $.param(query)
            window.location = url;
        })
    </script>
    <script>
