...
<div class="card">
    <div class="custom-header">
        {{ trans('global.pending') }} {{ trans('global.services') }} {{ trans('global.list') }}
        <div class="d-flex">
            <!-- Range Picker-->
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-CustomerAssign">
                <thead>
                    <tr align="center">
                        ...
                        <th class="text-nowrap">
                            {{ trans('cruds.invoice.fields.pending_date') }}
                        </th>
                        <th class="text-nowrap">
                ...
                <tbody id="tableBody">
                    ...
                    <tr data-entry-id="{{ $invoice->id }}" align="center">
                        <td>
                            {{ $loop->iteration }}
                        </td>
                        <td>
...
<script>
    ...
    $(document).on('click', '#filter', function() {
        ...
        $.ajax({
            type: 'GET',
            url: '/admin/customer-assigns/action/pending',
            data: {
                startDate: startDate,
                endDate: endDate,
            },
    ...
    $(document).on('click', '#export', function() {
            ...
            var url = "{{ route('admin.export.pending') }}?" + $.param(query)
            window.location = url;
        })
</script>
<script>
